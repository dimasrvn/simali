		   ...
		   <div class="row">
			  <div class="col-sm-12">
				<?php
					...
					// escape inputs data
					// Asign a query
					$query = "DELETE FROM tingkatan WHERE id_tingkatan = ".$id." ";
					// Execute the query
