...
<head>
    ...
    <title>SIMALI | Kelola Tingkatan</title>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active"><a href=""><i class="fa fa-university"></i> <span>Kelola Tingkatan</span></a></li>
			<?php
				}
					?>
			...
			<?php
				if ($_SESSION['lv']=='koor_doswal'){ 
					?>
            <li><a href="../doswal"><i class="fa fa-user-secret"></i> <span>Kelola Dosen Wali</span></a></li>
			<?php
				}
					?>
